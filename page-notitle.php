								...
								function share(obj){
									...
									if(obj=="weibo"){
										_URL=weiboShareURL+"url="+host_url+"&appkey="+appkey+"&title="+title+"&pic="+pic;
								 		...
								 		_URL=qzoneShareURL+"url="+host_url+"&title="+title+"&desc=&summary=&site=elfive&pic="+pic;
								 	}else if(obj=="qqchat"){
								 		_URL=qqchatShareURL+"url="+host_url+"&title="+title+"&desc=&summary=&site=elfive&pic="+pic;
								 	}
									window.open(_URL);
								}
								</script>
